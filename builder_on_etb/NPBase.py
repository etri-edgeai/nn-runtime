...
from NPInference import model_inference, model_initialize, \
    model_finalize, is_init, get_input_output_attributes

from NPEnum import DataAttribute
from NPError import unsupported_initialize, unsupported_finalize, UninitializedError
import NPLog as log
...
class Basemodel(metaclass=abc.ABCMeta):
    ...
    def run(self, input_data:Any, **kwargs):
        ...
        return post_result, (inference_done - inference_start)*1000*1000 # microseconds