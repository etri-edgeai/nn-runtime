...
class PoseResNet(nn.Module):
    ...
    def __init__(self, block, layers, heads, head_conv):
        ...
        self.smooth_layer1 = ConvBnRelu(256, 256)
        self.smooth_layer2 = ConvBnRelu(128, 128)
        self.smooth_layer3 = ConvBnRelu(64, 64)

        self.project_layer1 = ConvBnRelu(256 * block.expansion, 256)
        self.project_layer2 = ConvBnRelu(128 * block.expansion, 128)
        self.project_layer3 = ConvBnRelu(64 * block.expansion, 64)
    ...
    def forward(self, x):
        ...
        z = {}
        for head in self.heads:
            z[head] = self.__getattr__(head)(p1)
...
def get_pose_net(num_layers, heads, head_conv=128):
