...
class Resfpn34(Basemodel):
    ...
    def __init__(self):
        ...
        self.input_layer_location = None
        self.output_layer_location = None

        # using input/output layer locations only for TFLite.
        self.input_layer_location = [0]
        self.output_layer_location = [452, 458, 449, 455]
        
        # using nput/output layer names for TRT, ONNX, etc,.
        #self.input_layer_name = ["input"]
        #self.output_layer_name = ["output_0", "output_1", "output_2", "output_3"]
